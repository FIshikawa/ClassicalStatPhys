...
using Integrator =  integrator::VelocityVelretParallel;
...
using Hamiltonian =  hamiltonian::ClassicalXYFullyConnectedParallel;
...
int main(int argc, char **argv){
  ...
  int n_bin = 1000;
  int myid, numprocs, ierr; // set MPI porcess integers
 ...
 //end parameter define 
  ...
  dataput.output_result_3d(correlation_dat,domain,correlation_list,results_2d);
  dataput.output_result_3d(hist_dat,domain,hist_value_list,hist_values);
