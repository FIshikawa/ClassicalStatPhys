#ifndef HAMILTONIAN_CLASSICAL_XY_HPP
#define HAMILTONIAN_CLASSICAL_XY_HPP
...
public:
  ...
  static std::string name() { return "Classical XYspin Dynamics"; }
  ClassicalXY(int num_particles, double J, std::vector<std::vector<int > > table, int N_adj) : n_(num_particles), J_(J), table_(table),Nd_(N_adj){}
...
#endif //HAMILTONIAN_CLASSICAL_XY_HPP
