#ifndef HAMILTONIAN_FPU_GENERALIZED_FIXED_END_PARALLEL_HPP
#define HAMILTONIAN_FPU_GENERALIZED_FIXED_END_PARALLEL_HPP
...
class FPUGeneralizedFixedEndParallel {
public:
  static std::string name() { return "Classical Generalzied Fermi Pasta Ulam : fixed End : must use Open Boundary Chain Lattice : Parallel"; }
  // z[0...n-1]: position, z[n...2n-1]: momentum
  FPUGeneralizedFixedEndParallel(int num_particles, double J, double alpha, double beta, double gamma, double delta, 
