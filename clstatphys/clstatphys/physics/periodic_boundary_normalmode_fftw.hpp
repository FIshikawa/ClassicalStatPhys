#ifndef PERIODIC_BOUNDARY_NORMALMODE_FFTW_HPP
#define PERIODIC_BOUNDARY_NORMALMODE_FFTW_HPP

#include <vector>
#include <fftw3.h>
#include <complex>

void PeriodicBoundaryNormalModeFFTW(const std::vector<double>& z, std::vector<double>& z_k){
  ...
  plan_momentum = fftw_plan_r2r_1d(num_particles, p_in, p_out, FFTW_DHT, FFTW_ESTIMATE);
  plan_displace = fftw_plan_r2r_1d(num_particles, x_in, x_out, FFTW_DHT, FFTW_ESTIMATE);
