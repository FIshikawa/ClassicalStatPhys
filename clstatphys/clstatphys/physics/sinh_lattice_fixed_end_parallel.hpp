#ifndef HAMILTONIAN_SINH_LATTICE_FIXED_END_PARALLEL_HPP
#define HAMILTONIAN_SINH_LATTICE_FIXED_END_PARALLEL_HPP
...
class SinhLatticeFixedEndParallel {
public:
  ...
  SinhLatticeFixedEndParallel(int num_particles, double J, double alpha, std::vector<std::vector<int > > table, int N_adj) : n_(num_particles), J_(J), table_(table),Nd_(N_adj),alpha_(alpha){}
