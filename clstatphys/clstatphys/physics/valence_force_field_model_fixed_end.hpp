#ifndef HAMILTONIAN_VALENCE_FORCE_FIELD_MODEL_FIXED_END_HPP
#define HAMILTONIAN_VALENCE_FORCE_FIELD_MODEL_FIXED_END_HPP
...
class ValenceForceFieldModelFixedEnd{ 
public:
  ...
  ValenceForceFieldModelFixedEnd(int num_particles, double J, double alpha, double beta, std::vector<std::vector<int > > table, int N_adj) : n_(num_particles), J_(J), table_(table),Nd_(N_adj),alpha_(alpha),beta_(beta){}
...
#endif //HAMILTONIAN_VALENCE_FORCE_FIELD_MODEL_FIXED_END_HPP
