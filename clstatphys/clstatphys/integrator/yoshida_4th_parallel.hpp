...
class Yoshida4thParallel{
public:
  static std::string name() { return "4th order Yoshida method (Neri method) : parallelized"; }
  Yoshida4thParallel(int dim) : dim_(dim), k1_(dim), k2_(dim), k3_(dim), k4_(dim){}
  template<class F>
