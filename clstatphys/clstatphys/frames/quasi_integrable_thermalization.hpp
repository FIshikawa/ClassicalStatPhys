...
//  }
  ...
  results_2d["TodaEigenvaluesVariance"] = std::vector< std::vector<double> >(N_total_data, std::vector<double>(num_particles,0.0));
  results_2d["error_TodaEigenvaluesVariance"] = std::vector< std::vector<double> >(N_total_data, std::vector<double>(num_particles,0.0));
