...
class NormalModeEnsemblePeriodicBoundary{
public:
  static std::string name() {
    return "Nomal Mode Ensembe under Periodic Boundary"; }
  NormalModeEnsemblePeriodicBoundary(int num, int k_initial, int N_k, double E)
