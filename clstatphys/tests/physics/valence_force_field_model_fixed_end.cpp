...
namespace {
class ValenceForceFieldModelFixedEndTest: public ::testing::Test {
  protected:  
  virtual void SetUp(){
...
TEST_F(ValenceForceFieldModelFixedEndTest, EnergyTest) {
...
TEST_F(ValenceForceFieldModelFixedEndTest, ForceTest) {
  hamiltonian::ValenceForceFieldModelFixedEnd hamiltonian(num_particles,J,alpha,beta,pair_table,N_adj);
  // set integrator 
  ...
  std::vector<double> force_vector(2.0*num_particles);
