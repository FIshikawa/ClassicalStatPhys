...
TEST_F(FPUFixedEndParallelTest, EnergyTest) {
  hamiltonian::FPUFixedEndParallel hamiltonian(num_particles,J,alpha,beta,pair_table,N_adj);
...
TEST_F(FPUFixedEndParallelTest, ForceTest) {
  hamiltonian::FPUFixedEndParallel hamiltonian(num_particles,J,alpha,beta,pair_table,N_adj);
  // set integrator 
