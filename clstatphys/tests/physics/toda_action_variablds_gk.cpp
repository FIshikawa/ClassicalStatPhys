...
namespace {
class TodaActionVariablesGKTest: public ::testing::Test {
  protected:  
  virtual void SetUp(){
...
TEST_F(TodaActionVariablesGKTest, IntegrationTest) {
  ...
  TodaActionVariablesGK(action_variables, discriminant);
...
TEST_F(TodaActionVariablesGKTest, TimeDevelopTest) {
  ...
  TodaActionVariablesGK(action_variables_init, discriminant);
  ...
  TodaActionVariablesGK(action_variables_mid, discriminant);
  ...
  TodaActionVariablesGK(action_variables_fin, discriminant);
