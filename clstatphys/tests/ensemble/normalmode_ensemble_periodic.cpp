...
#include <clstatphys/ensemble/normalmode_ensemble_periodic_boundary.hpp>
...
class NormalModeEnsemblePeriodicTest : public ::testing::Test {
  ...
  virtual void SetUp(){
    ...
    std::mt19937 mt(seed);
    // create data set
    ensemble::NormalModeEnsemblePeriodicBoundary initializer(num_particles,k_initial, N_modes, total_energy);
